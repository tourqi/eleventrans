          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="relative h-64 lg:h-auto">
              ...
              <div className="absolute top-4 left-4">
                <Badge variant="accent">{t('featured.popular')}</Badge>
              </div>
            </div>
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-center">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">{td(featured.excerpt)}</p>

              {/* Quick facts */}
              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="flex items-center gap-2 text-sm text-gray-700">
                  <Clock className="w-4 h-4 text-primary-500" />
                  <span>{td(featured.meta.duration)}</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-700">
                  <Users className="w-4 h-4 text-primary-500" />
                  <span>{td(featured.meta.groupSize)}</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-700">
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                {featured.activities.slice(0, 4).map((act) => (
                  <Badge key={act} variant="default">{td(act)}</Badge>
                ))}
              </div>
