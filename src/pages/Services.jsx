    ...
    <>
      ...
      <PageHero>
        ...
        <p className="text-base text-white/80 leading-relaxed">
          Dari private trip hingga industrial visit — setiap layanan kami dirancang untuk
      ...
      <CTASection
        waMessage="Halo Eleven Trans! 👋 Saya mau tanya tentang layanan travel kalian. Bisa info lebih lanjut?"
      />
    </>
  );
}
...
function ServiceDetail() {
  ...
  const waMessage = `Halo Eleven Trans! 👋 Saya tertarik dengan layanan ${service.title}. Bisa minta info lebih lanjut?`;
  ...
  return (
    <>
      ...
      <PageHero backgroundImage={service.heroImage}>
        ...
        <Badge variant="accent" className="mb-3">{service.tagline}</Badge>
        ...
        <Button variant="whatsapp" size="lg" href={buildWhatsAppLink(waMessage)}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <SectionHeading
                eyebrow="Keunggulan"
                title={`Kenapa Pilih ${service.title}?`}
                center={false}
              />
      ...
      <CTASection
        title={`Tertarik ${service.title}?`}
        subtitle="Ceritakan rencana kamu — kami bantu wujudkan."
        waMessage={waMessage}
      />
    </>
  );
