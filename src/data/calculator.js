...
export const ARMADA_OPTIONS = [
  ...
  { id: 'big-bus-jb3',         name: 'Big Bus JB3 50 Seat',          capacity: '50 Seat',                passengerSeat: 50, type: 'Bus Besar',         minPax: 50, priceDalamKota: 3200000, priceLuarKota: 3900000, isBus: true  },
...
export const PENGINAPAN_OPTIONS = [
  { id: 'bintang-1', label: 'Bintang 1: Penginapan / Losmen', stars: 1, pricePerNight: 200000 },
 ...
 */
const LOKASI_META = {
  'pangandaran-citumang': { minPax: 18, pricePerPax: 600000, zone: 'luar-kota' },
  'ujung-genteng':        { minPax: 13, pricePerPax: 1000000, zone: 'luar-kota' },
  'pangalengan-rafting':  { minPax: 13, pricePerPax: 450000, zone: 'dalam-kota' },
  'trip-ciwidey':         { minPax: 13, pricePerPax: 450000, zone: 'dalam-kota' },
};
...
export const MAKAN_OPTIONS = [
  ...
  { id: 'makan-3', label: 'Paket Lengkap: Makan + Snack', pricePerPax: 75000, description: '2x nasi box + 1x snack' },
